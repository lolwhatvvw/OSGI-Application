package ru.ifmo.vovk.stage5.meduza;
...
@Designate(ocd = MeduzaServiceProvider.NewsConfig.class)
public class MeduzaServiceProvider extends AbstractNewsService implements NewsService {

    @ObjectClassDefinition(name = "Meduza news Service Configuration",
    ...
    public @interface NewsConfig {
        ...
        String newsName() default "Meduza";
        ...
        String newsUrl() default "https://meduza.global.ssl.fastly.net/rss2/all";

        @AttributeDefinition(
                name = "limit",
                description = "limit of the top words in Meduza news provider",
